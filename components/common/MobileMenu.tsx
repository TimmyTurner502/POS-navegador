...
import { ChartPieIcon, ShoppingCartIcon, ArchiveBoxIcon, DocumentTextIcon, UserGroupIcon, Cog6ToothIcon, UsersIcon, PresentationChartLineIcon, TruckIcon, BanknotesIcon, ClipboardDocumentListIcon, XMarkIcon, ShoppingBagIcon } from '../Icons';
